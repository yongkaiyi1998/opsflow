...
class StorePurchaseQuotationIntakeRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'documents.required' => 'Select at least one quotation.',
            'documents.max' => 'A batch may contain at most 20 quotations.',
            'documents.*.max' => 'Each quotation may not be larger than 10 MB.',
        ];
    }
}
