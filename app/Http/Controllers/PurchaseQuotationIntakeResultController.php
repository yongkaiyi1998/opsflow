...
class PurchaseQuotationIntakeResultController extends Controller
{
    /**
    ...
    public function __invoke(IntakeBatch $intakeBatch, DocumentIntake $documentIntake): View
    {
        ...
        $documentIntake->load(['aiInteraction', 'purchaseRequest']);

        return view('purchase-quotation-intakes.documents.show', compact('intakeBatch', 'documentIntake'));
    }
}
