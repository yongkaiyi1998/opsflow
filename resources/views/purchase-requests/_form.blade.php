...
<div class="form-section-heading"><h2>Request details</h2><p>Core information used for review and workflow routing.</p></div>
<div class="row g-3">
...
<section class="form-section">
<div class="form-section-heading d-flex flex-wrap justify-content-between align-items-center gap-2"><div><h2>Items</h2><p>Add each product or service included in this request.</p></div><button class="btn btn-sm btn-outline-primary" id="add-item" type="button">Add item</button></div>
...
<div class="form-actions"><button class="btn btn-primary" type="submit">Save draft</button><a class="btn btn-outline-secondary" href="{{ $purchaseRequest ? route('purchase-requests.show', $purchaseRequest) : route('purchase-requests.index') }}">Cancel</a></div>
